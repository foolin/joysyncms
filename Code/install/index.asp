...
<title>卓新内容管理系统（JSCMS）安装 -- Powered by Joysyn.com</title>
<style type="text/css">
<!--
body{
...
%>
    ...
    <div class="footer">
            <p>版权所有 (c)2009-2010，卓新网络（JoySyn.com）保留所有权利。 </p>
            <p>本系统由卓新网络（Joysyn.com）独立开发。Author: Foolin &nbsp;&nbsp; QQ: 970026999 E-mail: Foolin@126.com </p>
    </div>
...
<%Sub Step1()%>
	...
	<!--第一步:许可协议-->
    <div id="step1">
    	<div class="title">第一步：卓新内容管理系统（JoySyn CMS）安装许可协议</div>
        <div class="license">
          <p>感谢您选择卓新内容管理系统（JoySyn CMS以下简称JSCMS），JSCMS是一个简单又实用的小型站点程序，基于 ASP + Access 的技术开发，供客户使用。卓新内容管理系统（JSCMS）是原E酷内容管理系统（EekkuCMS）的升级版。 </p>
          <p>JSCMS 的官方网址是： <span style="color:#F00">www.joysyn.com</span></p>
          <p>为了使您正确并合法的使用本软件，请您在使用前务必阅读清楚下面的协议条款：</p>
          <p>一、本授权协议适用且仅适用于JSCMS 1.x.x 版本，卓新网络（Joysyn.com）对本授权协议拥有最终解释权。</p>
          <p>二、协议许可的权利 <br />
            &nbsp;&nbsp;&nbsp;&nbsp; 1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。<br />
            &nbsp;&nbsp;&nbsp;&nbsp; 2、您可以在协议规定的约束和限制范围内修改 JSCMS 源代码或界面风格以适应您的网站要求。 <br />
...
<p>版本最新更新：2010年7月17日 By Foolin </p>
        </div>
        <div class="btn">
...
%>
    <div id="step2">
    	<div class="title">第二步：卓新内容管理系统（JSCMS）安装</div>
        <form action="?action=step3" method="post" name="form1" onsubmit="return chkForm();">
        <table class="form">
            <tr>
                <td class="name">网站名称：</td><td class="inputtxt"><input name="Sitename" type="text" value="卓新网络" /> 请填写网站名称</td>
            </tr>
            <tr>
    ...
    <div id="cancel">
        ...
        <div class="cancel">
            ...
            &nbsp;&nbsp;<b>Author: Foolin(负零) </b><br />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp; 卓新网络: <a href="http://www.joysyn.com">http://www.joysyn.com</a><br /><br />
            本系统由卓新网络（Joysyn.com）独立开发。如果有任何问题或者建议，请联系作者，万分感谢！<br />
            </div>
        </div>
    </div>
...
Function CreateTable(strDbName, strUsername, strPassword)
	...
	'自定义标签：系统信息
	Conn.execute("INSERT INTO [MyTags] ([Name],[Info],[Code]) VALUES('AboutSys','关于系统信息','{sys:sys /}<br />作者：Foolin<br /> Email: Foolin@126.com <br /> 主页：http://www.LiuFu.org/Ling<br />卓新内容管理系统（JSCMS）官网：Http://www.joysyn.com<br />')")
	'自定义标签：友情链接
	Conn.execute("INSERT INTO [MyTags] ([Name],[Info],[Code]) VALUES('FriendLinks','友情链接','<a href=""http://www.joysyn.com""> -==- 卓新网络 -==- </a><br />"& Chr(10) & Chr(9) &"<a href=""http://www.liufu.org/ling/""> -==- 零星碎事 -==- </a><br />"& Chr(10) & Chr(9) &"')")
	'帮助页面
	Conn.execute("INSERT INTO [DiyPage] ([Title],[PageName],[Code],[State],[IsSystem]) VALUES('帮助文档','help.html','<p>这是我的第一个自定义页面，欢迎大家光临。</p><p>你只要在后台添加一个页面，然后引用该链接：</p><p><font color=""red"">http://您网站网址/安装目录/diypage.asp?id=<font color=""blue"">[您建立页面的ID]</font></font></p><p>或者</p><p><font color=""red"">http://您网站网址/安装目录/diypage.asp?url=<font color=""blue"">[您建立页面的名称]</font></font><br />即可打开这个自定义页面！</p><p>&nbsp;</p><p>如需帮助，请访问：http://www.joysyn.com，卓新网络络欢迎你。</p><p>你正在使用卓新内容管理系统（JSCMS）系统！</p><p><br /><a href=""http://www.joysyn.com/"">-==- 卓新内容管理系统（JSCMS）官方 -==- </a></p><p><br /></p><p><a href=""http://www.liufu.org/ling/"">-==- 作者主页 -==- </a><br /></p>',1,0)")
	'友情链接
...
Function CreateConfig(DbName)
	...
	If Len(strSiteName) = 0 Then strSiteName = "卓新网络"
	'系统信息
	...
	strTemp= strTemp & "KEYWORDS = " & Chr(34) & "卓新网络，卓新内容管理系统,JSCMS，卓新网络,www.joysyn.com，零星碎事，ling.liufu.org" & Chr(34) & keyEnter
	' SITEDESC变量
	strTemp= strTemp & "Dim DESCRIPTION" & keyTab & "'网站描述" & Chr(10) & Chr(9) 
	strTemp= strTemp & "DESCRIPTION = " & Chr(34) & "卓新内容管理系统（JSCMS）是一种小型站点内容管理系统，内含文章、图片、留言等基本功能，简单且方便使用！" & Chr(34) & keyEnter
	' TEMPLATEDIR变量
